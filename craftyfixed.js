    ...
    /**@
        ...
        */
        ...
        init: function (w, h) {
            ...
            this.width = (!w) ? Crafty.DOM.window.width : w;
            this.height = (!h) ? Crafty.DOM.window.height : h;
				if (Crafty.mobile) {
//					var scale, scaleX = Crafty.DOM.window.width / w,
//					scaleY = Crafty.DOM.window.height / h;
//					scale = scaleX < scaleY ? scaleX : scaleY;
					this.width = w;
					this.height = h;
//					alert(Crafty.DOM.window.width + ";" + Crafty.DOM.window.height);
				}
            //check if stage exists
            var crstage = document.getElementById(Crafty.gameId);
...
//            Crafty.addEvent(this, window, "resize", Crafty.viewport.reload);
            ...
            if (!crstage) {
                ...
                Crafty.stage.elem.id = Crafty.gameId;
            }
            ...
            if (Crafty.mobile) {
				...
				owidth = window.innerWidth || (window.document.documentElement.clientWidth || window.document.body.clientWidth);
				oheight = window.innerHeight || (window.document.documentElement.clientHeight || window.document.body.clientHeight);
                //stop mobile zooming and scrolling
                meta.setAttribute("name", "viewport");

				if (w/h >= owidth/oheight) {
					meta.setAttribute("content", "width=" + w + (Crafty.mobile == "android" ? "" : ",user-scalable=no"));
//					alert("set width" + (owidth + oheight));
				} else {
					meta.setAttribute("content", "width=" + Math.floor(h * owidth/oheight) + (Crafty.mobile == "android" ? "" : ",user-scalable=no"));
//					alert("set height" + owidth + ";" + oheight+";" + Math.floor(h * owidth/oheight));
				}
